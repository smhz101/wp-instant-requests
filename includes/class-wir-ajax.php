...
class WIR_Ajax {
	public static function submit() {
		...
		update_post_meta( $post_id, '_wir_thread', array( array(
			'type' => 'user', 'message' => wp_strip_all_tags( $msg ), 'time' => time(),
		) ) );
		...
		do_action( 'wir_request_created', $post_id, $request_created );
